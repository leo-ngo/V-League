...
class Tab2ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.playerNum.text = TeamData.num[indexPath.row]
        cell.playerName.text = TeamData.playerNameList[indexPath.row]
        cell.playerPos.text = TeamData.pos[indexPath.row]
